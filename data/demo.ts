...
const u = (photoId: string, w = 1200) =>
  `https://images.unsplash.com/${photoId}?w=${w}&q=75&auto=format&fit=crop&fm=webp`;
...
export const demoWorkshops: Workshop[] = [
  {
    ...
    status: 'Past',
    cover_image: u('photo-1554189097-c48c982a8de3'),
    gallery_images: [u('photo-1517245386807-bb43f82c33c4'), u('photo-1556761175-b413da4baf72')],
    content: `
    ...
    testimonials: [
      {
        quote: 'Transformed the way I approach visualizing my data. An essential course for any computational biologist.',
        author: 'Dr. Jane Doe',
  ...
  },
  {
    ...
    status: 'Past',
    cover_image: u('photo-1519452635265-7b1fbfd1e4e0'),
    gallery_images: [u('photo-1499244571948-7ccddb3583f1'), u('photo-1456325504744-8262a6a4a588')],
    content:
      '<p>Participants from around the globe joined this virtual workshop to learn how to create clear, concise, and compelling scientific figures that communicate research effectively. We explored case studies from top journals and practiced applying design theory to real-world data.</p>',
  },
  {
    id: 'demo-3',
    strand: 'ai',
    ...
    status: 'Past',
    cover_image: u('photo-1526649661456-89c7ed4d53b8'),
    gallery_images: [],
    content:
      '<p>This workshop focused on the intersection of data science and graphic design, teaching participants how to build compelling narratives around their research data.</p>',
  },
];
